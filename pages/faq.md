...
|7| 与此同时，竞赛部的所有成员进行着高强度高密度训练。 |
|8| 新进入竞赛部的同学，可以和老队员进行组队，也可自行组队。 |
|9| 竞赛部成员将代表学校参加全国各地的ACM比赛。|

|---|**第二学期**|
|:--- |:---|
|1| 本学期依旧会开设算法课（较高级的算法） |
|2| 本学期同样面向全校招收acmer，通过考核可以加入ACM竞赛部。 |
|3| 学期中段，将会举行ACM校赛（全校学生，除出题人和工作人员外，均可参加） |
|4| 竞赛部内会定期组织比赛训练，迎接省赛和全国邀请赛，同时也会组织参与西安部分学校的校赛|
|5| 学期后段，将会开始ACM暑期集训的报名，原则上所有学生均可报名，为期1个多月，主要是强化训练，建议有一定基础的同学再选择报名。（学校暑假不停水不停电，食堂照常开放）。|
...
---
$Q:$ **零基础怎么办？**  
$A:$  我们会有C语言的基础教学，同时网上也有很多友好的资源，一点都不用担心（其实很多学长也是零基础走过来的）。
...
---
$Q:$ 我应该如何提问呢？  **（划重点，这将是你学习之路必须要修炼的技巧）**
...
---
$Q:$ 去哪里 **刷题**？  
$A:$ 我们推荐的是在各大高校的 $OnlineJude$ 上进行练习，有[HDU][4]，[POJ][5]，[ZOJ][6]等等，以及CodeForce，洛谷。  
更多详情请见QQ群文件（CHD-ACM入门指南）
